...
```
vigolium-results/chamber-workspace/
...
- Only role that writes finding drafts to `vigolium-results/findings-draft/`
...
Within vigolium-audit-claude: agents communicate via the shared `debate.md` file AND `SendMessage`.
...
Within vigolium-audit-codex: agents poll `debate.md` for new sections (file-based coordination).
...
**Finding draft written to**: vigolium-results/findings-draft/p7-<NNN>-<slug>.md
